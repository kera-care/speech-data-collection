...
class ServiceUsageClient {
    ...
    constructor(opts) {
        ...
        const enableServiceResponse = protoFilesRoot.lookup('.google.api.serviceusage.v1.EnableServiceResponse');
        const enableServiceMetadata = protoFilesRoot.lookup('.google.api.serviceusage.v1.OperationMetadata');
        const disableServiceResponse = protoFilesRoot.lookup('.google.api.serviceusage.v1.DisableServiceResponse');
        const disableServiceMetadata = protoFilesRoot.lookup('.google.api.serviceusage.v1.OperationMetadata');
        const batchEnableServicesResponse = protoFilesRoot.lookup('.google.api.serviceusage.v1.BatchEnableServicesResponse');
        const batchEnableServicesMetadata = protoFilesRoot.lookup('.google.api.serviceusage.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.api.serviceusage.v1.ServiceUsage', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.serviceUsageStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.api.serviceusage.v1.ServiceUsage')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.api.serviceusage.v1.ServiceUsage, this._opts, this._providedCustomServicePath);
    ...
    batchGetServices(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
